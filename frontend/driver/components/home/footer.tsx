...
export default function Footer() {
    return (
        <footer className="bg-white dark:bg-dark-900 pt-16 pb-8 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-6">
                <div className="relative w-8 h-8">
                  ...
                  <div className="absolute inset-1 bg-primary-600 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-4 h-4">
                      <path d="M11.9999 3C8.41258 3 5.24327 4.95029 3.65002 7.9991C3.45867 8.37697 3.57162 8.83553 3.9055 9.0723C4.23938 9.30907 4.68222 9.22879 4.93355 8.91537C5.11003 8.69322 5.29603 8.48392 5.49097 8.28898C7.52724 6.25271 10.4727 5.25 13.5 5.25C14.3284 5.25 15 4.57843 15 3.75C15 2.92157 14.3284 2.25 13.5 2.25C12.6716 2.25 12 2.92157 12 3.75V3.75C12 4.57843 11.3284 5.25 10.5 5.25C9.67157 5.25 9 4.57843 9 3.75V3.75C9 2.92157 8.32843 2.25 7.5 2.25C6.67157 2.25 6 2.92157 6 3.75C6 4.57843 5.32843 5.25 4.5 5.25C3.67157 5.25 3 4.57843 3 3.75C3 2.92157 2.32843 2.25 1.5 2.25C0.671573 2.25 0 2.92157 0 3.75C0 4.57843 0.671573 5.25 1.5 5.25C2.32843 5.25 3 4.57843 3 3.75" />
                ...
                <span className="text-xl font-bold text-primary-600 ">QuickBite</span>
              </Link>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-6 dark:text-primary-300">Quick Links</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-6 dark:text-primary-300">Legal</h3>
              <ul className="space-y-4">
                <li>
                  <Link
                    href="#"
            ...
            <div>
              <h3 className="text-lg font-semibold mb-6 dark:text-primary-300">Contact Us</h3>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-600 dark:text-gray-300">123 Food Street, Tasty City, TC 12345</span>
                </li>
                <li className="flex items-start space-x-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-gray-600 dark:text-gray-300">support@quickbite.com</span>
                </li>
                <li className="flex items-start space-x-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
