  ...
  return (
    <div className="relative p-6">
      ...
      <div className={`${showModal ? "blur-sm" : ""}`}>
        ...
        {/* Hotels Card View */}
        <h2 className="text-3xl font-bold mb-8 text-gray-800">Your Hotels</h2>
            ...
            {hotels.map((hotel) => (
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-xl font-bold mb-2 text-gray-900">{hotel.hotelName}</h3>

                  <div className="text-gray-600 text-sm flex flex-col gap-1 mb-5">
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          {/* Modal Content */}
          <div className="relative bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl animate-fadeIn z-50">
            <button 
