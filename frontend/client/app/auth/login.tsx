...
import { ChevronLeft, Eye, EyeOff, Utensils } from "lucide-react";
  ...
  return (
    <div className="w-full bg-red-400 h-screen flex- items-center justify-center">
      <div className="flex flex-col items-center justify-center min-h-screen relative bg-gray-100">
        ...
        <div className="bg-white flex flex-col p-6 rounded-lg min-w-[340px]  shadow-md z-10">
          ...
          <div className="w-full max-w-md rounded-lg">
            ...
            <div className="flex justify-center items-center mt-6">
              ...
              <Link
                href="/auth/signup"
                className="ml-1 text-orange-500 font-bold"
              >
                Sign Up
              </Link>
            </div>
