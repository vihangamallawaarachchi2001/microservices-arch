    ...
    if (process === "resetPassword") {
      setDescription(
        <>
          ...
          <span className="font-bold">{email}</span> to reset your password.
        </>
      );
      ...
      setDescription(
        <>
          ...
          <span className="font-bold">{email}</span>. Verify your email to
          activate your account and enjoy delicious food.
        </>
      );
    }
  }, [process, email]);
